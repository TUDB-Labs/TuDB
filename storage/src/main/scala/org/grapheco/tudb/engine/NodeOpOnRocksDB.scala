...
import org.grapheco.tudb.store.node.{NodeLabelStore, NodeStore, NodeStoreSPI, StoredNodeWithProperty}
import org.grapheco.tudb.store.storage.{KeyValueDB, RocksDBStorage}
import org.rocksdb.{WriteBatch, WriteOptions}

import scala.collection.mutable

class NodeOpOnRocksDB(operationContext: OperationsContext) extends NodeOperations {
  private val nodeDB =
