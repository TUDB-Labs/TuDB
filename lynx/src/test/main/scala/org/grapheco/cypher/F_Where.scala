...
class F_Where extends TestBase {
  ...
  val n1 = TestNode(
    TestId(1),
    Seq(LynxNodeLabel("Swedish"), LynxNodeLabel("Person")),
    Map(
      LynxPropertyKey("name") -> LynxValue("Andy"),
      LynxPropertyKey("age") -> LynxValue(36),
      LynxPropertyKey("belt") -> LynxValue("white")
    )
  )
  val n2 = TestNode(
    TestId(2),
    Seq(LynxNodeLabel("Dog")),
    Map(LynxPropertyKey("name") -> LynxValue("Andy"))
  )
  val n3 = TestNode(
    TestId(3),
    Seq(LynxNodeLabel("Person")),
    Map(
      LynxPropertyKey("name") -> LynxValue("Peter"),
      LynxPropertyKey("email") -> LynxValue("peter_n@example.com"),
      LynxPropertyKey("age") -> LynxValue(35)
    )
  )
  val n4 = TestNode(
    TestId(4),
    Seq(LynxNodeLabel("Person")),
    Map(
      LynxPropertyKey("name") -> LynxValue("Timothy"),
      LynxPropertyKey("address") -> LynxValue("Sweden/Malmo"),
  ...
  val n5 = TestNode(
    TestId(5),
    Seq(LynxNodeLabel("Dog")),
    Map(LynxPropertyKey("name") -> LynxValue("Fido"))
  )
  val n6 = TestNode(
    TestId(6),
    Seq(LynxNodeLabel("Dog")),
    Map(LynxPropertyKey("name") -> LynxValue("Ozzy"))
  )
  val n7 = TestNode(
    TestId(7),
    Seq(LynxNodeLabel("Toy")),
    Map(LynxPropertyKey("name") -> LynxValue("Banana"))
  )
  ...
  val r1 = TestRelationship(
    ...
    TestId(1),
    TestId(2),
    Option(LynxRelationshipType("HAS_DOG")),
    Map(LynxPropertyKey("since") -> LynxValue(2016))
  )
  val r2 = TestRelationship(
    ...
    Map(LynxPropertyKey("since") -> LynxValue(1999))
  )
  val r3 = TestRelationship(
    ...
    TestId(4),
    Option(LynxRelationshipType("KNOWS")),
    Map(LynxPropertyKey("since") -> LynxValue(2012))
  )
  val r4 = TestRelationship(
    ...
    TestId(5),
    Option(LynxRelationshipType("HAS_DOG")),
    Map(LynxPropertyKey("since") -> LynxValue(2010))
  )
  val r5 = TestRelationship(
    ...
    TestId(6),
    Option(LynxRelationshipType("HAS_DOG")),
    Map(LynxPropertyKey("since") -> LynxValue(2018))
  )
  val r6 = TestRelationship(
    TestId(6),
    TestId(5),
    TestId(7),
    Option(LynxRelationshipType("HAS_TOY")),
    Map.empty
  )
  @Before
  def init(): Unit = {
    ...
    relationsInput.append(
      (
        "r5",
        RelationshipInput(
          Seq(r5.relationType.get),
          r5.props.toSeq,
          StoredNodeInputRef(r5.startNodeId),
          StoredNodeInputRef(r5.endNodeId)
        )
      )
    )
    relationsInput.append(
      (
        "r6",
        RelationshipInput(
          Seq(r6.relationType.get),
          r6.props.toSeq,
          StoredNodeInputRef(r6.startNodeId),
          StoredNodeInputRef(r6.endNodeId)
        )
      )
    )
  ...
  def booleanOperator(): Unit = {
    ...
    Assert.assertEquals(
      List("Andy", 36),
      List(res(0)("n.name"), res(0)("n.age")).map(f => f.asInstanceOf[LynxValue].value)
    )
    Assert.assertEquals(
      List("Peter", 35),
      List(res(1)("n.name"), res(1)("n.age")).map(f => f.asInstanceOf[LynxValue].value)
    )
    Assert.assertEquals(
      List("Timothy", 25),
      List(res(2)("n.name"), res(2)("n.age")).map(f => f.asInstanceOf[LynxValue].value)
    )
  }
  ...
  def filterOnRelationshipProperty(): Unit = {
    ...
    Assert.assertEquals(
      List("Peter", 35, "peter_n@example.com"),
      List(res(0)("f.name"), res(0)("f.age"), res(0)("f.email")).map(f =>
        f.asInstanceOf[LynxValue].value
      )
    )
  }
  ...
  def propertyExistenceChecking(): Unit = {
    ...
    Assert.assertEquals(
      List("Andy", "white"),
      List(res(0)("n.name"), res(0)("n.belt")).map(f => f.asInstanceOf[LynxValue].value)
    )
  }
  ...
  def escapingInRegularExpressions(): Unit = {
    ...
    Assert.assertEquals(
      List("Peter", 35, "peter_n@example.com"),
      List(res(0)("n.name"), res(0)("n.age"), res(0)("n.email")).map(f =>
        f.asInstanceOf[LynxValue].value
      )
    )
  }
  ...
  def filterOnPatternsUsingNOT(): Unit = {
    ...
    Assert.assertEquals(
      List("Peter", 35),
      List(res(0)("person.name"), res(0)("person.age")).map(f => f.asInstanceOf[LynxValue].value)
    )
    Assert.assertEquals(
      List("Timothy", 25),
      List(res(1)("person.name"), res(1)("person.age")).map(f => f.asInstanceOf[LynxValue].value)
    )
  }
  ...
  def filterOnRelationshipType(): Unit = {
    ...
    Assert.assertEquals(
      List("KNOWS", 1999),
      List(res(0)("type(r)"), res(0)("r.since")).map(f => f.asInstanceOf[LynxValue].value)
    )
    Assert.assertEquals(
      List("KNOWS", 2012),
      List(res(1)("type(r)"), res(1)("r.since")).map(f => f.asInstanceOf[LynxValue].value)
    )
  }
  ...
  def usingExistentialSubqueriesInWHERE(): Unit = {
    ...
    Assert.assertEquals(
      List("Andy"),
      List(res(0)("name")).map(f => f.asInstanceOf[LynxValue].value)
    )
    Assert.assertEquals(
      List("Peter"),
      List(res(1)("name")).map(f => f.asInstanceOf[LynxValue].value)
    )
  }
  ...
  def inOperator(): Unit = {
    ...
    Assert.assertEquals(
      List("Peter", 35),
      List(res(0)("a.name"), res(0)("a.age")).map(f => f.asInstanceOf[LynxValue].value)
    )
    Assert.assertEquals(
      List("Timothy", 25),
      List(res(1)("a.name"), res(1)("a.age")).map(f => f.asInstanceOf[LynxValue].value)
    )
  }
  ...
  def defaultToFalseIfPropertyIsMissing(): Unit = {
    ...
    Assert.assertEquals(
      List("Andy", 36, "white"),
      List(res(0)("n.name"), res(0)("n.age"), res(0)("n.belt")).map(f =>
        f.asInstanceOf[LynxValue].value
      )
    )
  }
  ...
  def defaultToTrueIfPropertyIsMissing(): Unit = {
    ...
    Assert.assertEquals(
      List("Peter", 35, null),
      List(res(1)("n.name"), res(1)("n.age"), res(1)("n.belt")).map(f =>
        f.asInstanceOf[LynxValue].value
      )
    )
    Assert.assertEquals(
      List("Timothy", 25, null),
      List(res(2)("n.name"), res(2)("n.age"), res(2)("n.belt")).map(f =>
        f.asInstanceOf[LynxValue].value
      )
    )
  }
  ...
  def filterOnNull(): Unit = {
    ...
    Assert.assertEquals(
      List("Peter", 35, null),
      List(res(0)("person.name"), res(0)("person.age"), res(0)("person.belt")).map(f =>
        f.asInstanceOf[LynxValue].value
      )
    )
  }
