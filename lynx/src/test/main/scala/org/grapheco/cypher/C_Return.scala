...
class C_Return extends TestBase {
  ...
  val n1 = TestNode(
    ...
    Map(
      ...
      LynxPropertyKey("age") -> LynxValue(55),
      LynxPropertyKey("happy") -> LynxValue("YES!")
    )
  )
  ...
  def returnProperty(): Unit = {
    ...
    Assert.assertEquals(
      n1.property(LynxPropertyKey("name")).get,
      res(0)("n.name").asInstanceOf[LynxValue]
    )
  }
  ...
  def returnAllElement(): Unit = {
    ...
    Assert.assertEquals(
      List(n1, LynxList(List(r1, n2, LynxList(List())))),
      res(0)("p").asInstanceOf[LynxValue].value
    )
    Assert.assertEquals(
      List(n1, LynxList(List(r2, n2, LynxList(List())))),
      res(1)("p").asInstanceOf[LynxValue].value
    )
  }
  ...
  def variableWithUncommonCharacters(): Unit = {
    ...
    Assert.assertEquals(
      "YES!",
      res(0)("`This isn\\'t a common variable`.happy").asInstanceOf[LynxValue].value
    )
  }
