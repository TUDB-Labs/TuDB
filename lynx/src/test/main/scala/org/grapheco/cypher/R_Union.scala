...
class R_Union extends TestBase {
  ...
  val n1 = TestNode(
    TestId(1),
    Seq(LynxNodeLabel("Actor")),
    Map(LynxPropertyKey("name") -> LynxValue("Anthony Hopkins"))
  )
  val n2 = TestNode(
    TestId(2),
    Seq(LynxNodeLabel("Actor")),
    Map(LynxPropertyKey("name") -> LynxValue("Hitchcock"))
  )
  val n3 = TestNode(
    TestId(3),
    Seq(LynxNodeLabel("Actor")),
    Map(
      LynxPropertyKey("name") -> LynxValue("Hellen Mirren"),
  ...
  val n4 = TestNode(
    ...
    Map(LynxPropertyKey("name") -> LynxValue("Hitchcock"), LynxPropertyKey("age") -> LynxValue(34))
  )
  ...
  val r2 = TestRelationship(
    ...
    TestId(1),
    TestId(4),
    Option(LynxRelationshipType("ACTS_IN")),
    Map.empty
  )
