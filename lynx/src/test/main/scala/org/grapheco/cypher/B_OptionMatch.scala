...
import org.grapheco.lynx.{NodeInput, RelationshipInput, StoredNodeInputRef, TestBase}
...
class B_OptionMatch extends TestBase {
  ...
  val m1 = TestNode(
    ...
    Map(LynxPropertyKey("name") -> LynxValue("Wall Street"))
  )
  val m2 = TestNode(
    TestId(7),
    Seq(LynxNodeLabel("Movie")),
    Map(LynxPropertyKey("name") -> LynxValue("The American President"))
  )
