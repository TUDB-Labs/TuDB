...
class CallTest extends TestBase {
  ...
  def testNonArgsCall(): Unit = {
    ...
    Assert.assertEquals(
      Map(
        "name" -> LynxList(List(LynxString("bluejoe"), LynxString("lzx"), LynxString("airzihao")))
      ),
      rs.records().toSeq.apply(0)
    )
  }
  ...
  def testWrongCall(): Unit = {
    Assert.assertThrows(
      classOf[UnknownProcedureException],
  ...
  def testAbs(): Unit = {
    Assert.assertEquals(
      LynxInteger(10),
      runOnDemoGraph(s"return abs(${20 - 30}) as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxFloat(9.8),
      runOnDemoGraph(s"return abs(${20.2 - 30}) as value").records().next()("value")
    )
  }
  ...
  def testCeil(): Unit = {
    Assert.assertEquals(
      LynxFloat(1.0),
      runOnDemoGraph(s"return ceil(0.1) as value").records().next()("value")
    )
  }
  ...
  def testFloor(): Unit = {
    Assert.assertEquals(
      LynxFloat(0.0),
      runOnDemoGraph(s"return floor(0.9) as value").records().next()("value")
    )
  }
  ...
  def testRound(): Unit = {
    Assert.assertEquals(
      LynxInteger(3),
      runOnDemoGraph(s"return round(3.141592) as value").records().next()("value")
    )
  }
  @Test
  ...
  def testSign(): Unit = {
    Assert.assertEquals(
      LynxFloat(-1.0),
      runOnDemoGraph(s"return sign(-17) as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxFloat(1.0),
      runOnDemoGraph(s"return sign(17) as value").records().next()("value")
    ...
    Assert.assertEquals(
      LynxFloat(0.0),
      runOnDemoGraph(s"return sign(0) as value").records().next()("value")
    )
  }
  ...
  def testE(): Unit = {
    Assert.assertEquals(
      LynxFloat(Math.E),
      runOnDemoGraph(s"return e() as value").records().next()("value")
    )
  }
  ...
  def testExp(): Unit = {
    Assert.assertEquals(
      LynxFloat(7.38905609893065),
      runOnDemoGraph(s"return exp(2) as value").records().next()("value")
    )
  }
  ...
  def testLog(): Unit = {
    Assert.assertEquals(
      LynxFloat(3.295836866004329),
      runOnDemoGraph(s"return log(27) as value").records().next()("value")
    )
  }
  ...
  def testLog10(): Unit = {
    Assert.assertEquals(
      LynxFloat(1.4313637641589874),
      runOnDemoGraph(s"return log10(27) as value").records().next()("value")
    )
  }
  ...
  def testSqrt(): Unit = {
    Assert.assertEquals(
      LynxFloat(16.0),
      runOnDemoGraph(s"return sqrt(256) as value").records().next()("value")
    )
  }
  ...
  def testAcos(): Unit = {
    Assert.assertEquals(
      LynxFloat(1.0471975511965979),
      runOnDemoGraph(s"return acos(0.5) as value").records().next()("value")
    )
  }
  ...
  def testAsin(): Unit = {
    Assert.assertEquals(
      LynxFloat(0.5235987755982989),
      runOnDemoGraph(s"return asin(0.5) as value").records().next()("value")
    )
  }
  ...
  def testAtan(): Unit = {
    Assert.assertEquals(
      LynxFloat(0.4636476090008061),
      runOnDemoGraph(s"return atan(0.5) as value").records().next()("value")
    )
  }
  ...
  def testAtan2(): Unit = {
    Assert.assertEquals(
      LynxFloat(0.6947382761967033),
      runOnDemoGraph(s"return atan2(0.5, 0.6) as value").records().next()("value")
    )
  }
  ...
  def testCos(): Unit = {
    Assert.assertEquals(
      LynxFloat(0.8775825618903728),
      runOnDemoGraph(s"return cos(0.5) as value").records().next()("value")
    )
  }
  ...
  def testCot(): Unit = {
    Assert.assertEquals(
      LynxFloat(1.830487721712452),
      runOnDemoGraph(s"return cot(0.5) as value").records().next()("value")
    )
  }
  ...
  def testPi(): Unit = {
    Assert.assertEquals(
      LynxFloat(Math.PI),
      runOnDemoGraph(s"return pi() as value").records().next()("value")
    )
  }
  ...
  def testRadians(): Unit = {
    Assert.assertEquals(
      LynxFloat(3.141592653589793),
      runOnDemoGraph(s"return radians(180) as value").records().next()("value")
    )
  }
  ...
  def testSin(): Unit = {
    Assert.assertEquals(
      LynxFloat(0.479425538604203),
      runOnDemoGraph(s"return sin(0.5) as value").records().next()("value")
    )
  }
  ...
  def testTan(): Unit = {
    Assert.assertEquals(
      LynxFloat(0.5463024898437905),
      runOnDemoGraph(s"return tan(0.5) as value").records().next()("value")
    )
  }
  ...
  def testLeft(): Unit = {
    Assert.assertEquals(
      LynxString("hel"),
      runOnDemoGraph("return left('hello', 3) as value").records().next()("value")
    )
  }
  ...
  def testRight(): Unit = {
    Assert.assertEquals(
      LynxString("llo"),
      runOnDemoGraph("return right('hello', 3) as value").records().next()("value")
    )
  }
  ...
  def testTrim(): Unit = {
    Assert.assertEquals(
      LynxString("hello"),
      runOnDemoGraph("return ltrim('    hello') as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxString("hello"),
      runOnDemoGraph("return rtrim('hello    ') as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxString("hello"),
      runOnDemoGraph("return trim('    hello  ') as value").records().next()("value")
    )
  }
  ...
  def testReplace(): Unit = {
    Assert.assertEquals(
      LynxString("hezzo"),
      runOnDemoGraph("return replace('hello', 'l', 'z') as value").records().next()("value")
    )
  }
  ...
  def testReverse(): Unit = {
    Assert.assertEquals(
      LynxString("olleh"),
      runOnDemoGraph("return reverse('hello') as value").records().next()("value")
    )
  }
  ...
  def testSplit(): Unit = {
    Assert.assertEquals(
      LynxList(List(LynxString("one"), LynxString("two"))),
      runOnDemoGraph("return split('one,two', ',') as value").records().next()("value")
    )
  }
  ...
  def testLowerAndUpper(): Unit = {
    Assert.assertEquals(
      LynxString("hello"),
      runOnDemoGraph("return toLower('HELLO') as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxString("HELLO"),
      runOnDemoGraph("return toUpper('hello') as value").records().next()("value")
    )
  }
  ...
  def testToString(): Unit = {
    Assert.assertEquals(
      LynxString("12"),
      runOnDemoGraph("return toString(12) as value").records().next()("value")
    )
  }
  @Test
  def testSubString(): Unit = {
    Assert.assertEquals(
      LynxString("llo"),
      runOnDemoGraph("return substring('hello', 2) as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxString("el"),
      runOnDemoGraph("return substring('hello', 1, 2) as value").records().next()("value")
    )
  }
  @Test
  def testTo(): Unit = {
    Assert.assertEquals(
      LynxInteger(10),
      runOnDemoGraph("return toInteger('10.2') as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxFloat(10.2),
      runOnDemoGraph("return toFloat('10.2') as value").records().next()("value")
    )
    Assert.assertEquals(
      LynxBoolean(false),
      runOnDemoGraph("return toBoolean('false') as value").records().next()("value")
    )
  }
  ...
  @Test
  def testNodes(): Unit = {
    val result = runOnDemoGraph(
      "match p = (a)-->(b)-->(c)-->(d) return nodes(p) as nodes, a, b, c, d;"
    ).records().next()
  ...
  def testRelationships(): Unit = {
    val result1 = runOnDemoGraph(
      "match p = (a{name:'bluejoe'})-[r:KNOWS]->(b) return relationships(p) as rels, r;"
    ).records().next()
    ...
    val result2 = runOnDemoGraph(
      "match p = (a{name:'bluejoe'})-[r1]->(b)-[r2]->(c)-[r3]->(d) return relationships(p) as rels, r1, r2, r3;"
    ).records().next()
    Assert.assertEquals(
      List(result2("r1"), result2("r2"), result2("r3")),
      result2("rels").asInstanceOf[LynxList].value
    )
  }
